"""
Django settings for exeo_portal project.
"""
...
WSGI_APPLICATION = 'exeo_portal.wsgi.application'
...
CORS_ALLOWED_ORIGINS = config(
    ...
    default='http://localhost:3000,http://127.0.0.1:3000,http://localhost:3001,http://127.0.0.1:3001,http://localhost:3002,http://127.0.0.1:3002,http://10.188.130.177:3000,http://10.188.130.177:3001,http://10.188.130.177:3002'
).split(',')
